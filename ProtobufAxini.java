...
// ProtobufAxini: helper class to construct Protobuf messages.
...
public class ProtobufAxini {
    private static Logger logger = LoggerFactory.getLogger(ProtobufAxini.class);
